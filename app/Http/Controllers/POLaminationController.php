...
try{
       ...
       $result = DB::table('voucher_tbl')->insert([
        ...
        "created_by" => 1,
        "voucher_type" => 'Purchase Order Lamination',
       ]);
...
$inventories = $request -> inventories;
    ...
    //------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
public function get_po_lamination_detail(Request $request, $voucherno){
    $result = DB::table('po_lamination_detail_view')
...
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
public function update_po_lamination(Request $request){
    DB::beginTransaction();
    try{
    ...
    DB::commit();
    $poType = 'Purchase Order lamination';
